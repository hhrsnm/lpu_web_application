...
include 'process/users_report.php';
    ...
    <div class="row flex">
        <div class="col bg-dark vh-100 sticky-top" style="width: 100px;">
            ...
            <ul style="font-size:130%;">
                ...
                <li class="list-group-item <?php echo $user_privilege == 1 ? '' : 'd-none' ?>" style="margin-bottom: 2rem;"><a href="user_account_table.php" class="text-lightskyblue text-decoration-none hover-me">User Account</a></li>
        ...
        <div class="col-8  flex-grow-1" style="background-image:url('css/b1gsite.jpg'); text-align:center;"> 
            ...
            <div class="px-5 bg-white">
                <h1 class="d-flex justify-content-center m-2" style="font-size:30px;">Users Report</h1>
