    ...
    <div class="row flex">
        <div class="col bg-dark vh-100 sticky-top" style="width: 100px;">
            ...
            <ul style="font-size:130%;">
                ...
                <li class="list-group-item <?php echo ($user_privilege == 1 || $user_privilege == 3) ? '' : 'd-none' ?>" style="margin-bottom: 2rem;"><a href="Clothes.php" class="text-lightskyblue text-decoration-none hover-me">POS</a></li>
