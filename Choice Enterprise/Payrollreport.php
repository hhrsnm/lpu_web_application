...
<head>
    ...
    <title>Payroll Report Page</title>
</head>
    ...
    <div class="row flex">
        <div class="col bg-dark vh-100 sticky-top" style="width: 100px;">
            ...
            <ul style="font-size:130%;">
                ...
                <li class="list-group-item" style="margin-bottom: 2rem;"><a href="Payrollreport.php" class="text-lightskyblue text-decoration-none">Payroll Report</a></li>
                        ...
                        <table class="table table-bordered bg-white rounded small">
                            <thead class="border-bottom">
                                <tr>
                                    ...
                                    <th class="py-6 ps-6  bg-dark"><span class="btn p-0 d-flex align-items-center text-white fw-bold px-3  pe-none">Basic Income</span></th>
                                    <th class="py-6 ps-6  bg-dark"><span class="btn p-0 d-flex align-items-center text-white fw-bold px-3  pe-none">Honorarium Income</span></th>
                                    <th class="py-6 ps-6  bg-dark"><span class="btn p-0 d-flex align-items-center text-white fw-bold px-3  pe-none">Other Income</span></th>
                                    <th class="py-6 ps-6  bg-dark"><span class="btn p-0 d-flex align-items-center text-white fw-bold px-3  pe-none">Gross Income</span></th>
                                    <th class="py-6 ps-6  bg-dark"><span class="btn p-0 d-flex align-items-center text-white fw-bold px-3  pe-none">Total Deduction</span></th>
                                    <th class="py-6 ps-6  bg-dark"><span class="btn p-0 d-flex align-items-center text-white fw-bold px-3  pe-none">Net Income</span></th>
                                    <th class="py-6 ps-6  bg-dark"><span class="btn p-0 d-flex align-items-center text-white fw-bold px-3  pe-none">Paydate</span></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
