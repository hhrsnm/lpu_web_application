    ...
    <div class="row flex">
        <div class="col bg-dark vh-100 sticky-top" style="width: 100px;">
            ...
            <ul style="font-size:130%;">
                ...
                <li class="list-group-item <?php echo ($user_privilege == 1 || $user_privilege == 3) ? '' : 'd-none' ?>" style="margin-bottom: 2rem;"><a href="Shoes.php" class="text-lightskyblue text-decoration-none hover-me">POS</a></li>
                        ...
                        for ($i = 1; $i < 21; $i++) {
                            ...
                            <div class='col hover-pos'onclick='handleItems(\"$label\", \"$price\")' role='button'>
                                <div class='card mb-4 mx-3 ' style='width: 190px;'>
                                    <div class='row g-0'>
                                        <img src='Shoes_images/$i.jpg' class='card-img-top rounded-start' alt='...' height='190'/>
